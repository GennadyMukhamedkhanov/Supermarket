...
class UserUpdateService(Service):
    ...
    def update_user(self):
        user = self.get_user()
        user.first_name = self.cleaned_data.get('first_name') if self.cleaned_data.get('first_name') else user.first_name
        ...
        user.phone_number = self.cleaned_data['phone_number'] if self.cleaned_data['phone_number'] else user.phone_number
